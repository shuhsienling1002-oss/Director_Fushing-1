...
with tabs[0]:
    ...
    show_item(5, "桃園市急難救助", "5,000元至6萬元", True, "申請人設籍本區，發生急難事由3個月以內申請。<br>(1)喪葬補助: 依身分類別審核救助7,000元至6萬元。<br>(2)醫療補助: 依身分類別審核救助5,000元至4萬元。<br>(3)失業或其他原因無法工作: 負擔主要家庭生計者，依身分類別審核救助5,000元至4萬元。<br>(4)財產因故未能及時運用: 依身分類別審核救助5,000元至4萬元。<br>(5)尚未獲得福利補助或保險給付前: 依身分類別審核救助5,000元至4萬元。", "區公所社會課")
